    ...
    return <section id='projects' className="flex  flex-col py-20 px-5 justify-center bg-primary text-white">
        <div className="w-full">
            <div className="flex flex-col px-10 py-5">
                ...
                <p>These are some of my best projects, including an innovative IoT project. I have built them using React and vanilla CSS. Check them out!.click the images to see the details about our projects</p>
            </div>
        </div>
        <div className="w-full">
            <div className='flex flex-col md:flex-row px-10 gap-5'>
                {config.projects.map((project) => (
                     <div className='relative'>
                        <img alt="project" className='h-[200px] w-[500px]' src={project.image}/>
